...
export default defineEventHandler(async (event) => {
  ...
  return await executePublicWriteController(event, 'persona:write', {
    payload: { personaId: rawId }, targetType: 'persona_soul', successStatusCode: 200, targetId: readPublicPersonaId,
  }, async () => {
    ...
    return toPublicJson(await event.context.applicationServices.soul.publishDraft('persona', personaId))
  })
})
